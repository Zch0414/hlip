...
- **(2026-04)**
  ...
  - We support MR-RATE and train <code>vit_base_scan_study_dualdinotxt1568</code> on MR-RATE using its provided report supervision. The resulting model achieves an AUC of 76.4 on the internal MR-RATE test split, and a balanced ACC of 89.1, 46.7, and 44.6 on the Pub-Brain-5 dataset's anomaly detection, tumor classification and diseases classification, respectively. The training command is provided in the Training section.
